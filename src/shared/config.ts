...
const schema = z.object({
  ...
  NETSUITE_PO_ETA_UPDATE_RESTLET_URL: optionalEnvString,
  MICROSOFT_GRAPH_ENABLED: z.preprocess((value) => parseBooleanEnv(value), z.boolean()).default(false),
  OUTLOOK_INGESTION_ENABLED: z.preprocess((value) => parseBooleanEnv(value), z.boolean()).default(false),
  OUTLOOK_MAILBOX: optionalEnvString,
  OUTLOOK_CUSTOMER_PO_FOLDER_NAME: optionalEnvString,
  OUTLOOK_MAX_MESSAGES: z.coerce.number().optional(),
  ...
  MICROSOFT_GRAPH_CLIENT_SECRET: optionalEnvString,
  MICROSOFT_GRAPH_ACCESS_TOKEN: optionalEnvString,
